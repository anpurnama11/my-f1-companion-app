...
- [ ] Leaderboard can render cached Driver and Constructor standings offline.
- [ ] My Team picker and favorites-backed Homepage sections can render from cached standings/catalogs when available.
- [ ] Empty-but-valid early-season standings/catalog payloads cache without being treated as corruption.
- [ ] Refresh failure preserves last good standings/catalog payloads and records attempt metadata.
- [ ] Rollover prunes old season-scoped standings and catalogs immediately after schedule promotion.
