...
do not blank the last good payload. All structured resources, including session
results, pitstops, circuit details, and Wikipedia summaries, distinguish
persisted writes, fresh skips, deferred work, retryable failures, and permanent
failures. The Countdown widget cache remains separate.
